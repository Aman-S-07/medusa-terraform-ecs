...
// node_modules/@medusajs/dashboard/dist/chunk-I7Q3WDNZ.mjs
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-list-5Z6N35N5-EKMIEN2M.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-6GX4SVXG-AGEP7Q4M.js")
                    },
                    {
                      path: "import",
                      lazy: () => import("./product-import-43YYSHGQ-OU4PY4H6.js")
                    },
                    {
                      path: "export",
                      lazy: () => import("./product-export-YW5I6CRB-JCVOWHD6.js")
                    }
                  ]
                },
                {
                  ...
                  errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-2FXRFY73-LAEJRNUF.js");
                    return {
                      Component: Outlet,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-2FXRFY73-LAEJRNUF.js"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-OF6Y3Z4A-SF7USYBC.js")
                        },
                        {
                          path: "edit-variant",
                          lazy: () => import("./product-variant-edit-NAYZXKH2-S5TVL4GX.js")
                        },
                        {
                          path: "sales-channels",
                          lazy: () => import("./product-sales-channels-IMLTBZXI-NQETF7YF.js")
                        },
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-DPDPFQWB-FCJOABVD.js")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-YZNTMITF-PKEVBKLJ.js")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-4CPN2STX-LEQUXOD6.js")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-NRT46T2Y-WD4F45JQ.js")
                        },
                        {
                          path: "prices",
                          lazy: () => import("./product-prices-6SSVGNNM-HMKRDONT.js")
                        },
                        {
                          path: "options/create",
                          lazy: () => import("./product-create-option-HI2ZVX2S-45PUP3JZ.js")
                        },
                        {
                          path: "options/:option_id/edit",
                          lazy: () => import("./product-edit-option-OR6OB4EV-VJ7Q7Q4U.js")
                        },
                        {
                          path: "variants/create",
                          lazy: () => import("./product-create-variant-HIJNEOSH-QJT7GSZN.js")
                        },
                        {
                          path: "stock",
                          lazy: () => import("./product-stock-G4GAR4G7-KZ75EWA3.js")
                        },
                        {
                          path: "metadata/edit",
                          lazy: () => import("./product-metadata-TJXUY465-BDDGHVTS.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./product-variant-detail-JMGSGVUK-57MN5V5B.js");
                        return {
                      ...
                      children: [
                        ...
                        {
                          path: "manage-items",
                          lazy: () => import("./product-variant-manage-inventory-items-HBFLXXJ6-AUYZ73I7.js")
                        },
                        {
                          path: "metadata/edit",
                          lazy: () => import("./product-variant-metadata-543SLWNL-7MJJUYIL.js")
                        }
                      ]
                    }
                  ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./category-list-H7QKPMFW-CXPSKNW3.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./category-create-RSQ6ZWMI-WTLGIJQD.js")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-W34LC4TR-DHISVDFJ.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./category-detail-SNOWYPYF-IA5X43U3.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./category-edit-XP2XYX62-IG3EYFMP.js")
                    },
                    {
                      path: "products",
                      lazy: () => import("./category-products-456BNGUX-QNBYKH3F.js")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-W34LC4TR-DHISVDFJ.js")
                    ...
                    {
                      path: "metadata/edit",
                      lazy: () => import("./categories-metadata-MNRHR4VL-EHROT4LT.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./order-list-KTYCJ4NW-H62NEJQC.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./order-detail-PI2MRGPH-KHCATUCM.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "fulfillment",
                      lazy: () => import("./order-create-fulfillment-T2IGZJKJ-6XRGDEAG.js")
                    },
                    {
                      path: "returns/:return_id/receive",
                      lazy: () => import("./order-receive-return-T66LLW4M-SOI4KPNR.js")
                    },
                    {
                      path: "allocate-items",
                      lazy: () => import("./order-allocate-items-NFV3KZAY-V3BWWLET.js")
                    },
                    {
                      path: ":f_id/create-shipment",
                      lazy: () => import("./order-create-shipment-HSCJ35JS-TP6PWGK3.js")
                    },
                    {
                      path: "returns",
                      lazy: () => import("./order-create-return-BKTAF3XV-CUQ3WLXN.js")
                    },
                    {
                      path: "claims",
                      lazy: () => import("./order-create-claim-NHBXMO53-MMBRRI7Z.js")
                    },
                    {
                      path: "exchanges",
                      lazy: () => import("./order-create-exchange-5QHKZKCK-A3RP7QAK.js")
                    },
                    {
                      path: "edits",
                      lazy: () => import("./order-create-edit-WPP6VCJU-DX7SWTG5.js")
                    },
                    {
                      path: "refund",
                      lazy: () => import("./order-create-refund-V5YDN6HL-SHO3N65A.js")
                    },
                    {
                      path: "transfer",
                      lazy: () => import("./order-request-transfer-BESJQ4LK-HI3SXQ72.js")
                    },
                    {
                      path: "email",
                      lazy: () => import("./order-edit-email-IJQ6KL5H-A5D7ANL7.js")
                    },
                    {
                      path: "shipping-address",
                      lazy: () => import("./order-edit-shipping-address-WARDSUOO-JEAGQ2GM.js")
                    },
                    {
                      path: "billing-address",
                      lazy: () => import("./order-edit-billing-address-HWIMAHS6-K44KPKQZ.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./order-metadata-KCYMT73L-2ONU72KG.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-QHDWJ3GD-GMC5PKAV.js")
                },
                {
                  path: "create",
                  lazy: () => import("./promotion-create-JAQ4EKZ6-RBXI2WLY.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./promotion-detail-RNDMYZUS-JQIETPK3.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./promotion-edit-details-VS7NOYWF-FFRGXJNW.js")
                    },
                    {
                      path: "add-to-campaign",
                      lazy: () => import("./promotion-add-campaign-4MRPKION-EUNNQFK7.js")
                    },
                    {
                      path: ":ruleType/edit",
                      lazy: () => import("./edit-rules-FQUZ2RLW-S7IE6D5J.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./campaign-list-CTRJOUWQ-YUDJ2G6K.js"),
                  children: []
                },
                {
                  path: "create",
                  lazy: () => import("./campaign-create-AOJJFFCT-WNJULDAQ.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./campaign-detail-XNB7LNCF-23C3DDMK.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./campaign-edit-TY5I5ZMS-JBVYTPVE.js")
                    },
                    {
                      path: "configuration",
                      lazy: () => import("./campaign-configuration-T7U7VQ63-YG2DIHO3.js")
                    },
                    {
                      path: "edit-budget",
                      lazy: () => import("./campaign-budget-edit-XG46WNQN-VXOBCJ54.js")
                    },
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-N5EH5KQC-66R3SVKM.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./collection-list-TVDNVOBK-GCFWM5G2.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./collection-create-6MZU3JJO-XW5FZPKK.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./collection-detail-2P2BLCSU-7IH32BOR.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./collection-edit-6OEMTTR4-UXJSYUAV.js")
                    },
                    {
                      path: "products",
                      lazy: () => import("./collection-add-products-B4DTO3DW-7ZN4FWDE.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./collection-metadata-G322Q7DJ-NI2HRARB.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./price-list-list-CPHVK7UL-GN6T6BGT.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./price-list-create-Y6WFBLGO-RLJ3JIZU.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./price-list-detail-GVXCBOSM-VNMB4KWG.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./price-list-edit-BIUM4ZK7-KARDYKAJ.js")
                    },
                    {
                      path: "configuration",
                      lazy: () => import("./price-list-configuration-SI7DWGVO-4BC4QDTO.js")
                    },
                    {
                      path: "products/add",
                      lazy: () => import("./price-list-prices-add-EKBUNFRZ-TKTBSF75.js")
                    },
                    {
                      path: "products/edit",
                      lazy: () => import("./price-list-prices-edit-TMYMPOVU-ECMAFNXQ.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-list-5DKBJ524-ZQFD3G6V.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./customer-create-BIM4YFGV-ASFQZVHE.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./customer-detail-VL22X5MT-SEUZO55Q.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./customer-edit-FJNPYFCK-JJO7Z4XX.js")
                    },
                    {
                      path: "create-address",
                      lazy: () => import("./customer-create-address-TPSDYZBN-4MMEVDSQ.js")
                    },
                    {
                      path: "add-customer-groups",
                      lazy: () => import("./customers-add-customer-group-IPTB4EZQ-XCUXBJTD.js")
                    },
                    {
                    ...
                    {
                      path: "metadata/edit",
                      lazy: () => import("./customer-metadata-5NPUMPZ2-W77UY6XG.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-group-list-LTSITGYF-SHPBF6XD.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./customer-group-create-7X4TZR54-ON447X45.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./customer-group-detail-GNZJOJFI-A45WJPT6.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./customer-group-edit-J3AGQAAF-FLVZFMPE.js")
                    },
                    {
                      path: "add-customers",
                      lazy: () => import("./customer-group-add-customers-BWCE7V4X-X6QD4YZA.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./customer-group-metadata-UPAPULMF-D7CUCZ46.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./reservation-list-CSLD2U6C-2DOQYYZU.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./reservation-create-46Z3MO5F-L2IV7YN5.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./reservation-detail-27UGTUXR-6QKXTX6K.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./edit-reservation-5MWHBS5G-U3VVUUN2.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./reservation-metadata-X2LJGYK5-UZOIES5G.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./inventory-list-B2ZR5RJS-YRLCCUD7.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./inventory-create-RXZ73PU6-A7UJ5MDW.js")
                    },
                    {
                      path: "stock",
                      lazy: () => import("./inventory-stock-S2IHUFRG-R6IWBVH6.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./inventory-detail-2EJ3GJW5-GOLQSD4R.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./edit-inventory-item-UYYLUJWI-QXAYCH52.js")
                    },
                    {
                      path: "attributes",
                      lazy: () => import("./edit-inventory-item-attributes-B5O5ODS4-FQM6NFLO.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./inventory-metadata-ANTF6AAJ-BCCTZCXH.js")
                    },
                    {
                      path: "locations",
                      lazy: () => import("./manage-locations-NP3ZSUAF-LIFQNFNJ.js")
                    },
                    {
                      path: "locations/:location_id",
                      lazy: () => import("./adjust-inventory-G2WX3VHL-BNSEXKGW.js")
                    }
                  ]
                }
              ]
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              path: "profile",
              errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
              lazy: () => import("./profile-detail-UJYGWVRT-5TBTK2DG.js"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./profile-edit-XO4IRFZY-J42ZEKW7.js")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./region-list-SIDHBM6S-OH3UCH3R.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./region-create-EEPWFVFN-52C57DPD.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./region-detail-NKX4R7DX-7626TDHT.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./region-edit-7VMCKSEG-LJMQD4E2.js")
                    },
                    {
                      path: "countries/add",
                      lazy: () => import("./region-add-countries-R6ACJCU7-HBRHXEMI.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./region-metadata-3MDULFOT-ZXVEZZRJ.js")
                    }
                  ]
                }
              ]
            },
            {
              path: "store",
              errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
              lazy: () => import("./store-detail-5EOIA7WX-NIJYZFY5.js"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./store-edit-UOVB36JW-QBCT4N5E.js")
                },
                {
                  path: "currencies",
                  lazy: () => import("./store-add-currencies-RVQJEBCM-VXOJNV2K.js")
                },
                {
                  path: "metadata/edit",
                  lazy: () => import("./store-metadata-QLN6PSX3-NGFAORU5.js")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./user-list-F3ESFWRV-CQEVL5SJ.js"),
                  children: [
                    {
                      path: "invite",
                      lazy: () => import("./user-invite-GM7SAJSL-SWSFWX4A.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./user-detail-Z2EH7M4F-YGOSAJ7U.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./user-edit-XTVRRK7B-4MLA2YPY.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./user-metadata-L64KDWSE-2E7254NN.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./sales-channel-list-GUWAETTZ-BRWGPSB7.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./sales-channel-create-GUI5GFH3-CPZLAU5E.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./sales-channel-detail-WITSNTXX-O2FS76A4.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./sales-channel-edit-DQYAVVKY-DK662RIP.js")
                    },
                    {
                      path: "add-products",
                      lazy: () => import("./sales-channel-add-products-7PFPVQWV-MAJOEN2Q.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./sales-channel-metadata-OPPWE2F5-EKQPVLVV.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./location-list-M4RYGH65-YCH3U7JY.js")
                },
                {
                  path: "create",
                  lazy: () => import("./location-create-LUP363ZB-TNLOGDR6.js")
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./shipping-profiles-list-RAQ7OTHC-QW7CMXYL.js"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./shipping-profile-create-KRMI6NUI-7IVTDXJL.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./shipping-profile-detail-FDUPDSH4-6VQKBBVD.js");
                        return {
                          Component: Component4,
                          loader,
                          handle: {
                      ...
                      children: [
                        {
                          path: "metadata/edit",
                          lazy: () => import("./shipping-profile-metadata-2XRWBNKS-RPCBMQSP.js")
                        }
                      ]
                    }
                  ]
                },
                {
                  path: ":location_id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./location-detail-OOQ5DUUB-WPREOSGD.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./location-edit-26K26G23-2HTYLJOF.js")
                    },
                    {
                      path: "sales-channels",
                      lazy: () => import("./location-sales-channels-QJD37RDT-5A3TFVKF.js")
                    },
                    {
                      path: "fulfillment-providers",
                      lazy: () => import("./location-fulfillment-providers-AMCSLQEZ-J6BUK7TF.js")
                    },
                    {
                      ...
                      children: [
                        {
                          ...
                          lazy: () => import("./location-service-zone-create-6MJCRY7U-SKMCRVHJ.js")
                        },
                        {
                          ...
                          children: [
                            {
                              path: "edit",
                              lazy: () => import("./location-service-zone-edit-74Q2BX26-6D6T7ISO.js")
                            },
                            {
                              path: "areas",
                              lazy: () => import("./location-service-zone-manage-areas-2EFMSKBL-D4XCEZUS.js")
                            },
                            {
                              ...
                              children: [
                                {
                                  path: "create",
                                  lazy: () => import("./location-service-zone-shipping-option-create-KVXM62IA-UTU4F74F.js")
                                },
                                {
                                  path: ":so_id",
                                  children: [
                                    {
                                      path: "edit",
                                      lazy: () => import("./location-service-zone-shipping-option-edit-QGVO2QGV-H4NYADP4.js")
                                    },
                                    {
                                      path: "pricing",
                                      lazy: () => import("./location-service-zone-shipping-option-pricing-5BAXQBBI-YVWCULHH.js")
                                    }
                                  ]
                                }
                              ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-tag-list-6PIJUDED-R2HQJPRS.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-tag-create-DO2UENTN-T3IISJVR.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./product-tag-detail-L5U4A5AW-Q5XA63KN.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./product-tag-edit-HZ277CEW-5FIUB5B2.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./workflow-execution-list-FMCAUT4Q-7ZPE4PVA.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./workflow-execution-detail-M4U764MG-U4PHLAVW.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-type-list-HZINOJXZ-3EZ5TVQI.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-type-create-VXEOY6IV-BKFAHTIN.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./product-type-detail-EL3TM722-JCPYVWS3.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./product-type-edit-EOBA5GJ3-2JVOMYOV.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./product-type-metadata-EEB4KPWS-A3FX4FI5.js")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./api-key-management-list-B5XUTFLG-4N3HI24S.js"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./api-key-management-create-2E66QLI2-2J3XGFUT.js")
                        }
                      ]
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./api-key-management-detail-M2RNF4DQ-RXIFAZVQ.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./api-key-management-edit-JNMQ3ZDJ-MGZRQVZD.js")
                    },
                    {
                      path: "sales-channels",
                      lazy: () => import("./api-key-management-sales-channels-PFGH3XNK-ELWZMWD2.js")
                    }
                  ]
                }
              ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./tax-region-list-WLTMUWAT-6IB6UJC6.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-53VKKNDE-Z2EZM6SC.js")
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: async () => {
                        const { Component: Component4 } = await import("./tax-region-detail-Y6YMXEZ2-FNGW27KH.js");
                        return {
                          Component: Component4
                        };
                      },
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./tax-region-edit-FFHB3EOA-BRP5JTI2.js")
                        },
                        {
                          path: "provinces/create",
                          lazy: () => import("./tax-region-province-create-FFXYN7M4-VDAKZRFP.js")
                        },
                        {
                          path: "overrides/create",
                          lazy: () => import("./tax-region-tax-override-create-RWONHTTM-KYX6J6MG.js")
                        },
                        {
                          path: "overrides/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-override-edit-76OYOE4R-Y2RZYC2V.js")
                        },
                        {
                          path: "tax-rates/create",
                          lazy: () => import("./tax-region-tax-rate-create-T2FKYRNI-LMZ72KPQ.js")
                        },
                        {
                          path: "tax-rates/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-rate-edit-VACYUP6R-32KKEOSL.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./tax-region-province-detail-OOYBGAGO-OVSTP6BN.js");
                        return {
                          Component: Component4,
                          loader,
                          handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./return-reason-list-L6JNK4GS-VWOHCM5E.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./return-reason-create-TFLUQVJH-QEQL2GDS.js")
                    },
                    {
                      path: ":id",
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./return-reason-edit-WN3KGPRR-SB5L7VTQ.js")
                        }
                      ]
                    }
                  ]
      ...
      children: [
        {
          ...
          children: [
            {
              path: "/login",
              lazy: () => import("./login-4HHGORJD-P7WIZIUS.js")
            },
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-XRSTMF5X-TIA55YBE.js")
            },
            {
              path: "/invite",
              lazy: () => import("./invite-IQITJV62-3BXN5ZB7.js")
            },
            {
              path: "*",
              lazy: () => import("./no-match-KSAPNRPO-62FTNPL4.js")
            }
          ]
        }
      ]
...
//# sourceMappingURL=chunk-BS6QEWFI.js.map
